...
header('Content-Disposition: attachment; filename="ReporteGeneralTecho.xls"'); 
...
<html lang="en">
  ...
  <body class="nav-md" style="margin-bottom: 0px;">
    ...
    <center>
            ...
            <h1>REPORTE GENERAL DE TECHO</h1></center>
                  ...
                  <div class="x_content">
                    ...
                    <div class="">
                     ...
                     <!--  <table style="width: 100%;background-color: white;margin-bottom: 25px;" border="1"> 
                        ...
                        <thead style="background-color: #2a3f54;color: white;font-weight: bolder;"> 
                          <tr class="headings">
                           ...
                           <th style="background-color: #2a3f54;color: white;font-weight: bolder;">FILA</th>
                            ...
                            <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" >PROMEDIO TECHO</th>
                            <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" >ESTADO</th>
                            <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="5" >ESTADO DEL TECHO</th>
                        ...
                        <tbody>
                   <?php  
                        $ni = $sel->consultaExportTecho($rondax,"1"); 
                        $ct = 1;$acu="";
                       while($mue = $ni->fetch_assoc()){ ?>
                        ...
                        <thead style="background-color: #2a3f54;color: white;font-weight: bolder;"> 
                          <tr class="headings">
                            ...
                            <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >CONDUCTO DE DRENAJE PLUVIAL</th>
                   ...
                   <?php  
                        ...
                        $ni = $sel->consultaExportTecho($rondax,"2"); 
                        $ct = 1;
                       while($mue = $ni->fetch_assoc()){ ?>
                          <tr class="">
                          ...
                          <?php }
                            ...
                            <td class="tg-yw4l">
                                  <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >COBERTURA DE CALAMINA</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportTecho($rondax,"3"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                               <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >CANALETA DE DRENAJE</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportTecho($rondax,"4"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                                       <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >IMPERMEABILIZANTE</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportTecho($rondax,"5"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                                  <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >GEOMEMBRANA</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportTecho($rondax,"6"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
