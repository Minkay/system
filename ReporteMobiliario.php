...
header('Content-Disposition: attachment; filename="ReporteGeneralMobiliario.xls"'); 
...
<html lang="en">
  ...
  <body class="nav-md" style="margin-bottom: 0px;">
    ...
    <center>
            ...
            <h1>REPORTE GENERAL DEL MOBILIARIO</h1></center>
                  ...
                  <div class="x_content">
                    ...
                    <div class="">
                     ...
                     <!--  <table style="width: 100%;background-color: white;margin-bottom: 25px;" border="1"> 
                        ...
                        <thead style="background-color: #2a3f54;color: white;font-weight: bolder;"> 
                          <tr class="headings">
                           ...
                           <th style="background-color: #2a3f54;color: white;font-weight: bolder;">FILA</th>
                            ...
                            <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" >PROMEDIO MOBILIARIO</th>
                            <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" >ESTADO</th>
                            <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="5" >BANQUETAS DE ESPERA</th>
                        ...
                        <tbody>
                   <?php  
                        $ni = $sel->consultaExportMobili($rondax,"1"); 
                        $ct = 1;
                       while($mue = $ni->fetch_assoc()){ ?>
                        ...
                        <thead style="background-color: #2a3f54;color: white;font-weight: bolder;"> 
                          <tr class="headings">
                            ...
                            <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >SILLAS FIJAS</th>
                        ...
                        <tbody>
                   <?php  
                        $ni = $sel->consultaExportMobili($rondax,"2"); 
                        $ct = 1;
                       while($mue = $ni->fetch_assoc()){ ?>
                          <tr class="">
                          ...
                          <?php }
                            ...
                            <td class="tg-yw4l">
                                  <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >SILLAS GIRATORIAS</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportMobili($rondax,"3"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                               <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >TACHOS</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportMobili($rondax,"4"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                                       <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >ORDENADORES DE COLA</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportMobili($rondax,"5"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                                  <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >MODULOS DE ATENCION</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportMobili($rondax,"6"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                                  <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >ESTANTES</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportMobili($rondax,"7"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                                  <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >CREDENZAS</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportMobili($rondax,"8"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                                  <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >ANAQUELES - ARCHIVO</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportMobili($rondax,"9"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                                  <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >ANAQUELES - ECONOMATO</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportMobili($rondax,"10"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
