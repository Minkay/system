...
header('Content-Disposition: attachment; filename="ReporteGeneralInterna.xls"');
...
<html lang="en">
  ...
  <body class="nav-md" style="margin-bottom: 0px;">
    ...
    <center>
            ...
            <h1>REPORTE GENERAL DE INFRAESTRUCTURA INTERNA</h1></center>
                     ...
                     <!--  <table style="width: 100%;background-color: white;margin-bottom: 25px;" border="1"> 
                          ...
                          <tr>
                            <td class="tg-yw4l">
                                 <table id="example" style="width: 100%;" border="1" >
                                            <thead style="background-color: #2a3f54;color: white;font-weight: bolder;"> 
                                              ...
                                              <tr class="headings">
                                               ...
                                               <th style="background-color: #2a3f54;color: white;font-weight: bolder;">FILA</th>
                                                ...
                                                <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" >PROMEDIO INF. INTERNA</th>
                                            ...
                                            <tbody>
                                       <?php  
                                            $ni = $sel->consultaExportInternaG($rondax); 
                                            $ct = 1;
                             ...
                             <td class="tg-yw4l">
                                        <table id="example" style="width: 100%;" border="1" >
                                                ...
                                                <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >Pared / Piso / Techo / Iluminacion</th>
                                                ...
                                                <tbody>
                                                <?php  
                                                $ni = $sel->consultaExportInterna($rondax,"1","Pared / Piso / Techo / Iluminacion");
                                                $ct = 1;
                                                while($mue = $ni->fetch_assoc()){ ?>
                                                <tr class="">
                           ...
                           <!-- <td class="tg-yw4l">
                                        <table id="example" style="width: 100%;" border="1" >
                                                ...
                                                <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >PAREDES</th>
                                                ...
                                                <tbody>
                                                <?php  
                                                $ni = $sel->consultaExportInterna($rondax,"1","Paredes");
                                                $ct = 1;
                                                while($mue = $ni->fetch_assoc()){ ?>
                                                <tr class="">
                                                 <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                            ...
                            <td class="tg-yw4l">
                                  <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >TECHO</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"1","Techo");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                            ...
                            <td class="tg-yw4l">
                               <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"2","Pared / Piso / Techo / Iluminacion");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                        ...
                        <!--    <td class="tg-yw4l">
                                       <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"2","Paredes");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                            ...
                            <td class="tg-yw4l">
                                  <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"2","Techo");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                            ...
                            <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"3","Pared / Piso / Techo / Iluminacion");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                        ...
                        <!--    <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"3","Paredes");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                            ...
                            <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"3","Techo");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                            ...
                            <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"4","Pared / Piso / Techo / Iluminacion");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                          ...
                          <!--  <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"4","Paredes");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                            ...
                            <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"4","Techo");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                            ...
                            <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"5","Pared / Piso / Techo / Iluminacion");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                         ...
                         <!--   <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"5","Paredes");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                            ...
                            <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"5","Techo");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                            ...
                            <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"6","Pared / Piso / Techo / Iluminacion");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                        ...
                        <!--    <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"6","Paredes");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                            ...
                            <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"6","Techo");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                            ...
                            <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"7","Pared / Piso / Techo / Iluminacion");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                         ...
                         <!--   <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"7","Paredes");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                              ...
                              <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"7","Techo");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                              ...
                              <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"8","Pared / Piso / Techo / Iluminacion");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                           ...
                           <!--  <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"8","Paredes");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                             ...
                             <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"8","Techo");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                             ...
                             <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"9","Pared / Piso / Techo / Iluminacion");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                           ...
                           <!--  <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"9","Paredes");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                             ...
                             <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"9","Techo");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                             ...
                             <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"10","Pared / Piso / Techo / Iluminacion");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                          ...
                          <!--   <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"10","Paredes");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                             ...
                             <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"10","Techo");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                             ...
                             <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"11","Piso");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                          ...
                          <!--   <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"11","Paredes");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                             ...
                             <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"11","Techo");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                             ...
                             <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"12","Pared / Piso / Techo / Iluminacion");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                          ...
                          <!--   <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"12","Paredes");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                             ...
                             <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"12","Techo");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                             ...
                             <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >APARATOS SANITARIOS</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"12","Aparatos sanitarios");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                            ...
                            <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >EQUIPAMIENTO/ACCESORIOS DE BANO</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"12","Equipamiento/Accesoerios de baño");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
