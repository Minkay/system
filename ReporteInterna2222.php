                          ...
                          <tr>
                            <td class="tg-yw4l">
                             ...
                             <td class="tg-yw4l">
                                        <table id="example" style="width: 100%;" border="1" >
                                                ...
                                                <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >PISO</th>
                                                ...
                                                <tbody>
                                                <?php  
                                                $ni = $sel->consultaExportInterna($rondax,"1","Piso");
                                                $ct = 1;
                                                while($mue = $ni->fetch_assoc()){ ?>
                                                <tr class="">
                            ...
                            <td class="tg-yw4l">
                               <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"2","Piso");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                            ...
                            <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"3","Piso");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                            ...
                            <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"4","Piso");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                            ...
                            <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"5","Piso");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                            ...
                            <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"6","Piso");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                            ...
                            <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"7","Piso");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                            ...
                            <td class="tg-yw4l">
                              ...
                              <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"8","Piso");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                             ...
                             <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"9","Piso");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                             ...
                             <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"10","Piso");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
                             ...
                             <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportInterna($rondax,"12","Piso");
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td> 
