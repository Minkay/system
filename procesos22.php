...
<h4 class="panel-title" > > DOC. MANTENIMIENTO PERIODICO -------------------------------------------------------------------------------------------- PUNTAJE :
                                              ...
                                              <div class="panel-body">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tbody>
                                                             ...
                                                             <tr>
                                                              <?php 
                                        $ser = $sel->internaSelect('1',$cod); while($mue = $ser->fetch_assoc()){                           
                                           
                                      ?>
                                                         <th scope="row" rowspan="4" style="vertical-align: inherit;text-align: center;">AREA DE CAJA - VENTANILLAS</th>
                                                           <?php  
                                                            $pt1 =  $mue["puntaje"];
                                                              echo "<input  type='hidden' value='$pt1' id='p1' />";
                                                              if($mue["to1"]=="NO"){
 ...
 <tr>
                                                              <?php 
                                        $ser = $sel->internaSelect('2',$cod); while($mue = $ser->fetch_assoc()){                           
                                           
                                      ?>
                                                         <th scope="row" rowspan="4" style="vertical-align: inherit;text-align: center;">AREA DE ESPERA</th>
                                                           <?php  
                                                            $pt1 =  $mue["puntaje"];
                                                              echo "<input  type='hidden' value='$pt1' id='p1' />";
                                                              if($mue["to1"]=="NO"){
                                    ...
                                    ?>   
                                                             ...
                                                             <tr>
                                                              <?php 
                                        $ser = $sel->internaSelect('3',$cod); while($mue = $ser->fetch_assoc()){                           
                                           
                                      ?>
                                                         <th scope="row" rowspan="4" style="vertical-align: inherit;text-align: center;">AREA DE PLATAFORMA/OPERACIONES</th>
                                                           <?php  
                                                            $pt1 =  $mue["puntaje"];
                                                              echo "<input  type='hidden' value='$pt1' id='p1' />";
                                                              if($mue["to1"]=="NO"){
                                    ...
                                    ?>   
                                                             ...
                                                             <tr>
                                                              <?php 
                                        $ser = $sel->internaSelect('4',$cod); while($mue = $ser->fetch_assoc()){                           
                                           
                                      ?>
                                                         <th scope="row" rowspan="4" style="vertical-align: inherit;text-align: center;">AREA DE ASESORES DE NEGOCIOS</th>
                                                           <?php  
                                                            $pt1 =  $mue["puntaje"];
                                                              echo "<input  type='hidden' value='$pt1' id='p1' />";
                                                              if($mue["to1"]=="NO"){
                                    ...
                                    ?>   
                                                             ...
                                                             <tr>
                                                              <?php 
                                        $ser = $sel->internaSelect('5',$cod); while($mue = $ser->fetch_assoc()){                           
                                           
                                      ?>
                                                         <th scope="row" rowspan="4" style="vertical-align: inherit;text-align: center;">SALA DE REUNIONES</th>
                                                           <?php  
                                                            $pt1 =  $mue["puntaje"];
                                                              echo "<input  type='hidden' value='$pt1' id='p1' />";
                                                              if($mue["to1"]=="NO"){
                                    ...
                                    ?>   
                                                             ...
                                                             <tr>
                                                              <?php 
                                        $ser = $sel->internaSelect('6',$cod); while($mue = $ser->fetch_assoc()){                           
                                           
                                      ?>
                                                         <th scope="row" rowspan="4" style="vertical-align: inherit;text-align: center;">AREA DE RACK</th>
                                                           <?php  
                                                            $pt1 =  $mue["puntaje"];
                                                              echo "<input  type='hidden' value='$pt1' id='p1' />";
                                                              if($mue["to1"]=="NO"){
                                    ...
                                    ?>   
                                                            ...
                                                            <tr>
                                                              <?php 
                                        $ser = $sel->internaSelect('7',$cod); while($mue = $ser->fetch_assoc()){                           
                                    ...
                                    ?>   
                                                            ...
                                                            <tr>
                                                              <?php 
                                        $ser = $sel->internaSelect('8',$cod); while($mue = $ser->fetch_assoc()){                           
                                           
                                      ?>
                                                         <th scope="row" rowspan="4" style="vertical-align: inherit;text-align: center;">ARCHIVO</th>
                                                           <?php  
                                                            $pt1 =  $mue["puntaje"];
                                                              echo "<input  type='hidden' value='$pt1' id='p1' />";
                                                              if($mue["to1"]=="NO"){
                                    ...
                                    ?>   
                                                            ...
                                                            <tr>
                                                              <?php 
                                        $ser = $sel->internaSelect('9',$cod); while($mue = $ser->fetch_assoc()){                           
                                           
                                      ?>
                                                         <th scope="row" rowspan="4" style="vertical-align: inherit;text-align: center;">ECONOMATO</th>
                                                           <?php  
                                                            $pt1 =  $mue["puntaje"];
                                                              echo "<input  type='hidden' value='$pt1' id='p1' />";
                                                              if($mue["to1"]=="NO"){
                                    ...
                                    ?>   
                                                            ...
                                                            <tr>
                                                              <?php 
                                        $ser = $sel->internaSelect('10',$cod); while($mue = $ser->fetch_assoc()){                           
                                           
                                      ?>
                                                         <th scope="row" rowspan="4" style="vertical-align: inherit;text-align: center;">KITCHEN</th>
                                                           <?php  
                                                            $pt1 =  $mue["puntaje"];
                                                              echo "<input  type='hidden' value='$pt1' id='p1' />";
                                                              if($mue["to1"]=="NO"){
                                    ...
                                    ?>   
                                                            ...
                                                            <tr>
                                                              <?php 
                                        $ser = $sel->internaSelect('11',$cod); while($mue = $ser->fetch_assoc()){                           
                                           
                                      ?>
                                                         <th scope="row" rowspan="4" style="vertical-align: inherit;text-align: center;">LACTARIO</th>
                                                           <?php  
                                                            $pt1 =  $mue["puntaje"];
                                                              echo "<input  type='hidden' value='$pt1' id='p1' />";
                                                              if($mue["to1"]=="NO"){
                                    ...
                                    ?>   
                                                            ...
                                                            <tr>
                                                              <?php 
                                        $ser = $sel->internaSelect('12',$cod); while($mue = $ser->fetch_assoc()){                           
                                           
                                      ?>
                                                         <th scope="row" rowspan="4" style="vertical-align: inherit;text-align: center;">ESCALERAS / PASADIZOS</th>
                                                           <?php  
                                                            $pt1 =  $mue["puntaje"];
                                                              echo "<input  type='hidden' value='$pt1' id='p1' />";
                                                              if($mue["to1"]=="NO"){
                                    ...
                                    ?>   
                                                                     ...
                                                                     <tr>
                                                              <?php 
                                        $ser = $sel->internaSelect('13',$cod); while($mue = $ser->fetch_assoc()){                           
                                           
                                      ?>
                                                         <th scope="row" rowspan="4" style="vertical-align: inherit;text-align: center;">SERVICIOS HIGIÉNICOS</th>
                                                           <?php  
                                                            $pt1 =  $mue["puntaje"];
                                                              echo "<input  type='hidden' value='$pt1' id='p1' />";
                                                              if($mue["to1"]=="NO"){
