                      ...
                      $ser = $sel->ObservacionLogistica($cod);
                       while($mue = $ser->fetch_assoc()){ 
                               ...
                               if($mue["to1"]=='NO' && $mue["observacion"] !=""){
                                    ...
                                    echo "<img width='150' height='90' src='https://minkay.com.pe/system/DATA/" .$mue["imagen"]. "'>";
                                ...
                                if($mue["to2"]=='NO' && $mue["obs2"] !=""){
                                    ...
                                    echo "<img width='150' height='90' src='https://minkay.com.pe/system/DATA/" .$mue["img2"]. "'>";
                                ...
                                if($mue["to3"]=='NO'  && $mue["obs3"] !=""){
                                    ...
                                    echo "<img width='150' height='90' src='https://minkay.com.pe/system/DATA/" .$mue["img3"]. "'>";
                                  ...
                                  //  echo "<td class='' style='text-align: center;vertical-align: middle;'>" .$mue["ac3"]."</td>";   
                                    ...
                                    echo "<img width='150' height='90' src='https://minkay.com.pe/system/DATA/" .$mue["img4"]. "'>";
