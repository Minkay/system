...
$img=$code."/".$file;
	...
	if (isset($_FILES['archivo']) ) 
          {
            $ni = $sel->InsertServicios($id,$to,$im,$me2,$cre2,$re2,$ac2,$obs,$img,$me,$cri,$res,$ac);
                  ...
                  <div class="x_content">
                        ...
                        <form method="post" id="reg_mobil" enctype="multipart/form-data" class="formulario">
                            <div class="form-inline">
                             <?php 
                          $com ;
                          $ser = $sel->ObservacionServicios($id);
                          while($mue = $ser->fetch_assoc()) {
                           ...
                           ?>
                            ...
                            <div class="form-inline">
                              ...
                              <button type="submit" class="btn btn-danger" style="float: right;" id="actualizado">ACTUALIZAR</button>
