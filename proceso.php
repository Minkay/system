...
<html lang="en">
  ...
  <body class="nav-md">
                  ...
                  <div class="col-md-13">
                    <h3><small style="font-weight: 700;font-size:13px;">
                      <?php 
                             ...
                             // echo "<input id='uh' type='text' value='".$mue["age"]."'";
         //echo "Zona: ".$mue["zona"]." | Agencia: <p id='uh'>".$mue["age"]."</p> | Región: ".$mue["re"]." | Fecha Registro: ".$mue["fe"];
         $uh = $mue["age"] ;
         $idzona = $mue["zona"] ;
                                }
   ...
   <a href="javascript:history.back(1)" class="btn btn-success btn-xs" style="float: left;"> << Regresar</a>
                                    ...
                                    <div class="accordion" id="accordion" role="tablist" aria-multiselectable="true">
                                        <div class="panel">
                                            ...
                                            <a class="panel-heading collapsed" role="tab" id="headingTwo" data-toggle="collapse" data-parent="#accordion" href="#collapseone" aria-expanded="false" aria-controls="collapseTwo" style="color: white;">
                                             <?php  
                                                         $suma= 0;$count=0;$resul=0;$fnum1=0;
                                                         
                                                              $ser = $sel->manPuntaje($cod);
                                                              $ser1 = $sel->maPuntaje($cod); 
                                                              while($mue = $ser->fetch_assoc()){ 
                                                              $count++;
                                                              $suma = $suma + (int)$mue["puntaje"]  ;
                                                              $fnum1 = mysqli_num_rows($ser1);
                                                              $resul = $suma / $count ;
                                                         }
                                                  ?>
...
<h4 class="panel-title" > > DOC. MANTENIMIENTO PERIODICO -------------------------------------------------------------------------------------------- PUNTAJE :
                                                ...
                                                <div class="panel-body">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tbody>
                                                             ...
                                                             <tr>
                                                              <?php 
                                                  //  echo "<input id='uh' type='text' value='".$uh."'";
					                            ...
					                            ?>
                                                         <th scope="row"  style="vertical-align: inherit;text-align: center;">AIRE ACONDICIONADO</th>
                                                           <?php  
                                                              ...
                                                              if($mue["to1"]=="NO"){
                                                              //  echo "<td style='background-color: red;color: white;' id='uh'>".$uh."</td>";   
                                        ...
                                        <div class="panel">
                                            <a class="panel-heading collapsed" role="tab" id="headingTwo" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" style="color: white;">
                                                  <?php  
                                                         $suma= 0;$count=0;$resul=0 ;$fnum2=0;
                                                         
                                                         $ser = $sel->logisticaPuntaje($cod);
                                                          $ser1 = $sel->logisticPuntaje($cod);
                                                          while($mue = $ser->fetch_assoc()){ 
                                                              $count++;
                                                              $suma = $suma + (int)$mue["puntaje"];
                                                              $fnum2 = mysqli_num_rows($ser1);
                                                              $resul = $suma / $count  ;
                                                              // echo $mue["puntaje"];
                                                         }
                                        ...
                                        <div class="panel">
                                            <a class="panel-heading collapsed" role="tab" id="headingThree" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree" style="color: white;">
                                             <?php  
                                                         $suma= 0;$count=0;$resul=0 ;$fnum3=0;
                                                         
                                                         $ser = $sel->serviciosPuntaje($cod); 
                                                         $ser1 = $sel->servicioPuntaje($cod); 
                                                         while($mue = $ser->fetch_assoc()){ 
                                                              $count++;
                                                              $suma = $suma + (int)$mue["puntaje"]  ;
                                                              $fnum3 = mysqli_num_rows($ser1);
                                                              $resul = $suma / $count ;
                                                             // echo $mue["puntaje"];
                                                         }
                                                  ?>
                                                         ...
                                                         <th scope="row" rowspan="4" style="vertical-align: inherit;text-align: center;">LACTARIO (CUARTO/ESPACIO APROPIADO)</th>
                                                           <?php
                                                            $pt1 =  $mue["puntaje"];
                                                              echo "<input  type='hidden' value='$pt1' id='p1' />"; 
                                                              if($mue["to1"]=="NO"){
                                                              echo "<td style='background-color: red;color: white;'>Tiene lactario (ambiente/espacio apropiado)
                                                              </td>";
                                                  echo "<td style='text-align: center;background-color: red;color: white;'>NO</td>";
                                    ...
                                    ?>   
                                      ...
                                      ?>
                                                         <th scope="row" rowspan="4" style="vertical-align: inherit;text-align: center;">ACTIVOS EN DESUSO Y OBS</th>
                                                           <?php  
                                                              $pt1 =  $mue["puntaje"];
                                                              echo "<input  type='hidden' value='$pt1' id='p1' />";
                                                              if($mue["to1"]=="NO"){
                                    ...
                                    ?>   
                                      ...
                                      ?>
                                                         <th scope="row" rowspan="4" style="vertical-align: inherit;text-align: center;">E.A.A. QUE NO SON REQUERIDOS</th>
                                                           <?php  
                                                             $pt1 =  $mue["puntaje"];
                                                              echo "<input  type='hidden' value='$pt1' id='p1' />";
                                                              if($mue["to1"]=="NO"){
                                    ...
                                    ?>   
                                         ...
                                         <div class="panel">
                                            <a class="panel-heading" role="tab" id="headingOne" data-toggle="collapse" data-parent="#accordion" href="#collapsecuatro" aria-expanded="false" aria-controls="collapsecuatro" style="color: white;">
                                             <?php  
                                                         $suma= 0;$count=0;$resul=0 ;$fnum4=0;
                                                         
                                                         $ser = $sel->externaPuntaje($cod);
                                                         $ser1 = $sel->externPuntaje($cod);
                                                          while($mue = $ser->fetch_assoc()){ 
                                                              $count++;
                                                              $suma = $suma + (int)$mue["puntaje"]  ;
                                                              $fnum4 = mysqli_num_rows($ser1);
                                                              $resul = $suma / $count ;
                                                         }
                                                  ?>
                                    ...
                                    ?>   
                                         ...
                                         <div class="panel">
                                            <a class="panel-heading" role="tab" id="headingOne" data-toggle="collapse" data-parent="#accordion" href="#collapse5" aria-expanded="false" aria-controls="collapse5" style="color: white;">
                                             <?php  
                                                         $suma= 0;$count=0;$resul=0 ;$fnum5=0;
                                                         
                                                         $ser = $sel->techoPuntaje($cod);
                                                         $ser1 = $sel->techPuntaje($cod);
                                                          while($mue = $ser->fetch_assoc()){ 
                                                              $count++;
                                                              $suma = $suma + (int)$mue["puntaje"]  ;
                                                              $fnum5 = mysqli_num_rows($ser1);
                                                              $resul = $suma / $count ;
                                                         }
                                                  ?>
 ...
 <tr>
                                    ...
                                    ?>   
                                         ...
                                         <div class="panel">
                                            <a class="panel-heading" role="tab" id="headingOne" data-toggle="collapse" data-parent="#accordion" href="#collapse6" aria-expanded="false" aria-controls="collapse6" style="color: white;">
                                             <?php  
                                                         $suma= 0;$count=0;$resul=0 ;$fnum6=0;
                                                         
                                                         $ser = $sel->internaPuntaje($cod); 
                                                         $ser1 = $sel->internPuntaje($cod);
                                                         while($mue = $ser->fetch_assoc()){ 
                                                              $count++;
                                                              $suma = $suma + (int)$mue["puntaje"]  ;
                                                              $fnum6 = mysqli_num_rows($ser1);
                                                              $resul = $suma / $count ;
                                                         }
                                                  ?>
                                        ...
                                        <div class="panel">
                                            <a class="panel-heading" role="tab" id="headingOne" data-toggle="collapse" data-parent="#accordion" href="#collapse7" aria-expanded="false" aria-controls="collapse7" style="color: white;">
                                             <?php  
                                                         $suma= 0;$count=0;$resul=0;$fnum7=0;
                                                         
                                                         $ser = $sel->mobiliarioPuntaje($cod);
                                                         $ser1 = $sel->mobiliariPuntaje($cod);
                                                          while($mue = $ser->fetch_assoc()){ 
                                                              $count++;
                                                              $suma = $suma + (int)$mue["puntaje"]  ;
                                                              $fnum7 = mysqli_num_rows($ser1);
                                                              $resul = $suma / $count ;
                                                         }
                                                  ?>
                                    ...
                                    ?>   
                                         ...
                                         <div class="panel">
                                            <a class="panel-heading" role="tab" id="headingOne" data-toggle="collapse" data-parent="#accordion" href="#collapse8" aria-expanded="false" aria-controls="collapse8" style="color: white;">
                                             <?php  
                                                         $suma= 0;$count=0;$resul=0;$fnum8=0;
                                                         
                                                         $ser = $sel->equipoPuntaje($cod);
                                                         $ser1 = $sel->equipPuntaje($cod);
                                                          while($mue = $ser->fetch_assoc()){ 
                                                              $count++;
                                                              $suma = $suma + (int)$mue["puntaje"]  ;
                                                              $fnum8 = mysqli_num_rows($ser1);
                                                              $resul = $suma / $count ;
                                                         }
                                                  ?>
         ...
         <iframe src="principalver.php?codigo=<?php echo $r1; ?>&r2=<?php echo $r2; ?>&r3=<?php echo $r3; ?>&r4=<?php echo $r4; ?>&r5=<?php echo $r5; ?>&r6=<?php echo $r6; ?>&r7=<?php echo $r7; ?>&r8=<?php echo $r8; ?>&pui=<?php echo $uh; ?>" style="width: 100%;height: 510px;" frameborder="0" ></iframe>
...
<?php 
  $comp= $fnum1 + $fnum2 + $fnum3 + $fnum4 + $fnum5 + $fnum6 + $fnum7 + $fnum8;

  if($comp>="82"){                                          
       $ser = $sel->UpdateChk($cod,"Terminado");                                          
  }else{
      $ser = $sel->UpdateChk($cod,"Sin terminar");
  }
  ...
  $ser = $sel->insertTotales($cod,$ronda,$idzona,$r1, $r2 ,$r3, $r4, $r5, $r6,$r7,$r8,$ResulAgencia);
