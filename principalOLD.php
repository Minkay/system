...
<script src="./js/sumatoria.js"></script>
  ...
  function refrescar() {
            ...
            $.post('https://minkay.com.pe/sistema/Modelo/refrescar.php',
             function(data){
              if (data != "[]") {
                    var item = $.parseJSON(data);                    
                    $.each(item, function (i, valor) {
                       
                       $.post("https://minkay.com.pe/sistema/procesos.php?cod="+ valor.id_cod+"&ronda="+valor.ronda, function(htmlexterno){
...
<table border="1" width="500">
                        ...
                        <td class="tg-yw4l" style="text-align: center;background-color: white;"> > 4.5 y < 5 </td>
                         <?php 
                          $ni = $sel->graficosMuestraPara("1","4.60","4.99",$rondx);
                          $fill = mysqli_num_rows($ni); 
                         ...
                         ?>
                          <?php 
                          $ni = $sel->graficosMuestraPara("2","4.60","4.99",$rondx);
                          $fill = mysqli_num_rows($ni); 
                         ...
                         ?>
                          <?php 
                          $ni = $sel->graficosMuestraPara("3","4.60","4.99",$rondx);
                          $fill = mysqli_num_rows($ni); 
                         ...
                         ?>
                         <?php 
                          $ni = $sel->graficosMuestra("4.60","4.99",$rondx);
                          $fill = mysqli_num_rows($ni); 
                        ...
                        <td class="tg-yw4l" style="text-align: center;background-color: white;"> > 3.6 y <= 4.5</td>
                         <?php 
                          $ni = $sel->graficosMuestraPara("1","3.70","4.59",$rondx);
                          $fill = mysqli_num_rows($ni); 
                         ...
                         ?>
                          ...
                          <?php 
                          $ni = $sel->graficosMuestraPara("2","3.70","4.59",$rondx);
                          $fill = mysqli_num_rows($ni); 
                         ...
                         ?>
                          <?php 
                          $ni = $sel->graficosMuestraPara("3","3.70","4.59",$rondx);
                          $fill = mysqli_num_rows($ni); 
                         ...
                         ?>
                          <?php 
                          $ni = $sel->graficosMuestra("3.70","4.59",$rondx);
                          $fill = mysqli_num_rows($ni); 
                        ...
                        <td class="tg-yw4l" style="text-align: center;background-color: white;">> 2.9 y <= 3.6</td>
                        <?php 
                          $ni = $sel->graficosMuestraPara("1","2.91","3.69",$rondx);
                          $fill = mysqli_num_rows($ni); 
                         ...
                         ?>
                          <?php 
                          $ni = $sel->graficosMuestraPara("2","2.91","3.69",$rondx);
                          $fill = mysqli_num_rows($ni); 
                         ...
                         ?>
                          <?php 
                          $ni = $sel->graficosMuestraPara("3","2.91","3.69",$rondx);
                          $fill = mysqli_num_rows($ni); 
                         ...
                         <?php 
                          $ni = $sel->graficosMuestra("2.91","3.69",$rondx);
                          $fill = mysqli_num_rows($ni); 
                        ...
                        <td class="tg-yw4l" style="text-align: center;background-color: white;"> > 0 y <= 2.9</td>
                         <?php 
                          $ni = $sel->graficosMuestraPara("1","0.01","2.99",$rondx);
                          $fill = mysqli_num_rows($ni); 
                         ...
                         ?>
                          <?php 
                          $ni = $sel->graficosMuestraPara("2","0.01","2.99",$rondx);
                          $fill = mysqli_num_rows($ni); 
                         ...
                         ?>
                          <?php 
                          $ni = $sel->graficosMuestraPara("3","0.01","2.99",$rondx);
                          $fill = mysqli_num_rows($ni); 
                         ...
                         ?>
                          ...
                          <?php 
                          $ni = $sel->graficosMuestra("0.01","2.99",$rondx);
                          $fill = mysqli_num_rows($ni); 
