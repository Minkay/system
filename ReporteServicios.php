...
header('Content-Disposition: attachment; filename="ReporteGeneralServicios.xls"'); 
...
<html lang="en">
  ...
  <body class="nav-md" style="margin-bottom: 0px;">
    ...
    <center>
            ...
            <h1>REPORTE GENERAL DE SERVICIOS</h1></center>
                  ...
                  <div class="x_content">
                    ...
                    <div class="">
                     ...
                     <!--  <table style="width: 100%;background-color: white;margin-bottom: 25px;" border="1"> 
                        ...
                        <thead style="background-color: #2a3f54;color: white;font-weight: bolder;"> 
                          <tr class="headings">
                           ...
                           <th style="background-color: #2a3f54;color: white;font-weight: bolder;">FILA</th>
                            ...
                            <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" >PROMEDIO SERVICIOS</th>
                            <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" >ESTADO</th>
                            <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="5" >PROGRAMA / OPINION</th>
                        ...
                        <tbody>
                   <?php  
                        $ni = $sel->consultaExportServi($rondax,"1"); 
                        $ct = 1;
                       while($mue = $ni->fetch_assoc()){ ?>
                        ...
                        <thead style="background-color: #2a3f54;color: white;font-weight: bolder;"> 
                          <tr class="headings">
                            ...
                            <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >ENERGIA ELECTRICA</th>
                        ...
                        <tbody>
                   <?php  
                        $ni = $sel->consultaExportServi($rondax,"2"); 
                        $ct = 1;
                       while($mue = $ni->fetch_assoc()){ ?>
                          <tr class="">
                          ...
                          <?php }
                            ...
                            <td class="tg-yw4l">
                                  <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >AGUA</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportServi($rondax,"3"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                               <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >SERVICIO DE LIMPIEZA</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportServi($rondax,"4"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                                       <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >ANEXOS TELEFONICOS</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportServi($rondax,"5"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                                  <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >DISPENSADOR DE AGUA</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportServi($rondax,"6"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >PROYECTOR MULTIMEDIA</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportServi($rondax,"7"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >LACTARIO</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportServi($rondax,"8"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >FRIO BAR - LACTARIO</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportServi($rondax,"9"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >KITCHENET  </th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportServi($rondax,"10"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >FRIO BAR</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportServi($rondax,"11"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >HORNO MICROONDAS</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportServi($rondax,"12"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportServi($rondax,"13"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >REPOSTERO / ALACENA</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportServi($rondax,"14"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >MESA / COMEDOR</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportServi($rondax,"15"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >SUMIDERO DE RACK</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportServi($rondax,"16"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >SSHH DISCAPACITADOS</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportServi($rondax,"17"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >SUMIDERO DE SSHH DISCA.</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportServi($rondax,"18"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >SSHH MIXTO</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportServi($rondax,"19"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >SUMIDERO DE SSHH MIXTO</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportServi($rondax,"20"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                              ...
                              <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >ACTIVOS EN DESUSO Y OBS</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportServi($rondax,"21"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                              ...
                              <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >E.A.A. QUE NO SON REQUERIDOS</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportServi($rondax,"22"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
