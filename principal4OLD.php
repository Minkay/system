                ...
                <tr>
                  <td class="tg-yw4l">SSHH VARONES</td>
                     ...
                     <?php 
                          ...
                          <a href='ContadorAgenciaServicios.php?ag=1&zo=1' target='_blank' title='VER' >".$fnum."</a></td>";
                ...
                <tr>
                  <td class="tg-yw4l">SSHH MUJERES</td>
                     ...
                     <?php 
                          ...
                          <a href='ContadorAgenciaServicios.php?ag=2&zo=1' target='_blank' title='VER' >".$fnum."</a></td>";
                ...
                <tr>
                  <td class="tg-yw4l">SSHH DISCAPACITADOS</td>
                     ...
                     <?php 
                          ...
                          <a href='ContadorAgenciaServicios.php?ag=3&zo=1' target='_blank' title='VER' >".$fnum."</a></td>";
                ...
                <tr>
                  <td class="tg-yw4l">SSHH MIXTO</td>
                     ...
                     <?php 
                          ...
                          <a href='ContadorAgenciaServicios.php?ag=4&zo=1' target='_blank' title='VER' >".$fnum."</a></td>";
                ...
                <tr>
                  <td class="tg-yw4l">SUMIDEROS SSHH VARONES</td>
                     ...
                     <?php 
                          ...
                          <a href='ContadorAgenciaServicios.php?ag=5&zo=1' target='_blank' title='VER' >".$fnum."</a></td>";
                ...
                <tr>
                  <td class="tg-yw4l">SUMIDERO SSHH MUJERES</td>
                     ...
                     <?php 
                          ...
                          <a href='ContadorAgenciaServicios.php?ag=6&zo=1' target='_blank' title='VER' >".$fnum."</a></td>";
                ...
                <tr>
                  <td class="tg-yw4l">SUMIDERO SSHH DISCAPACITADOS</td>
                     ...
                     <?php 
                          ...
                          <a href='ContadorAgenciaServicios.php?ag=7&zo=1' target='_blank' title='VER' >".$fnum."</a></td>";
                ...
                <tr>
                  <td class="tg-yw4l">SUMIDERO SSHH MIXTO</td>
                     ...
                     <?php 
                          ...
                          <a href='ContadorAgenciaServicios.php?ag=8&zo=1' target='_blank' title='VER' >".$fnum."</a></td>";
                ...
                <tr>
                  <td class="tg-yw4l">SUMIDERO RACK</td>
                     ...
                     <?php 
                          ...
                          <a href='ContadorAgenciaServicios.php?ag=9&zo=1' target='_blank' title='VER' >".$fnum."</a></td>";
                ...
                <tr>
                  <td class="tg-yw4l">CUENTA SOLO CON SSHH MIXTO</td>
                     ...
                     <?php 
                          ...
                          <a href='ContadorAgenciaServicios.php?ag=10&zo=1' target='_blank' title='VER' >".$fnum."</a></td>";
