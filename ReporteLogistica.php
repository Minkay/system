...
header('Content-Disposition: attachment; filename="ReporteGeneralLogistica.xls"'); 
...
<html lang="en">
  ...
  <body class="nav-md" style="margin-bottom: 0px;">
    ...
    <center>
            ...
            <h1>REPORTE GENERAL DE LOGISTICA</h1></center>
                  ...
                  <div class="x_content">
                    ...
                    <div class="">
                     ...
                     <!--  <table style="width: 100%;background-color: white;margin-bottom: 25px;" border="1"> 
                        ...
                        <thead style="background-color: #2a3f54;color: white;font-weight: bolder;"> 
                          <tr class="headings">
                           ...
                           <th style="background-color: #2a3f54;color: white;font-weight: bolder;">FILA</th>
                            ...
                            <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" >PROMEDIO LOGISTICA</th>
                            <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" >ESTADO</th>
                            <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="5" >AB. ECONOMATO</th>
                        ...
                        <tbody>
                   <?php  
                        $ni = $sel->consultaExportLogi($rondax,"1"); 
                        $ct = 1;
                       while($mue = $ni->fetch_assoc()){ ?>
                        ...
                        <thead style="background-color: #2a3f54;color: white;font-weight: bolder;"> 
                          <tr class="headings">
                            ...
                            <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >AB. FORMATERIA  </th>
                        ...
                        <tbody>
                   <?php  
                        $ni = $sel->consultaExportLogi($rondax,"2"); 
                        $ct = 1;
                       while($mue = $ni->fetch_assoc()){ ?>
                          <tr class="">
                          ...
                          <?php }
                            ...
                            <td class="tg-yw4l">
                                  <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >SERVICIO COURIER</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportLogi($rondax,"3"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                               <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >AB. DE BIENES</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportLogi($rondax,"4"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
