...
header('Content-Disposition: attachment; filename="ReporteGeneralEquipamiento.xls"'); 
                  ...
                  <div class="x_content">
                    ...
                    <div class="">
                     ...
                     <!--  <table style="width: 100%;background-color: white;margin-bottom: 25px;" border="1"> 
                        ...
                        <thead style="background-color: #2a3f54;color: white;font-weight: bolder;"> 
                          <tr class="headings">
                           ...
                           <th style="background-color: #2a3f54;color: white;font-weight: bolder;">FILA</th>
                            ...
                            <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="5" >INSTALACIONES ELÉCTRICAS Y DE RED</th>
                        ...
                        <tbody>
                   <?php  
                        $ni = $sel->consultaExportEquipo($rondax,"1"); 
                        $ct = 1;
                       while($mue = $ni->fetch_assoc()){ ?>
                        ...
                        <thead style="background-color: #2a3f54;color: white;font-weight: bolder;"> 
                          <tr class="headings">
                            ...
                            <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >ILUMINACION</th>
                        ...
                        <tbody>
                   <?php  
                        $ni = $sel->consultaExportEquipo($rondax,"2"); 
                        $ct = 1;
                       while($mue = $ni->fetch_assoc()){ ?>
                          <tr class="">
                          ...
                          <?php }
                            ...
                            <td class="tg-yw4l">
                                  <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >UPS</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportEquipo($rondax,"3"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                               <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >GRUPO ELECTROGENO</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportEquipo($rondax,"4"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                                       <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >AIRE ACONDICIONADO 1</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportEquipo($rondax,"5"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                                  <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >RACK - SERVIDOR</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportEquipo($rondax,"6"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >CISTERNA Y BOMBAS</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportEquipo($rondax,"7"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >TANQUE ELEVADO</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportEquipo($rondax,"8"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >TV, DVD Y RACK</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportEquipo($rondax,"9"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >LUCES DE EMERGENCIA</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportEquipo($rondax,"10"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >EXTINTORES</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportEquipo($rondax,"11"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >PERSIANAS</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportEquipo($rondax,"12"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
                            ...
                            <td class="tg-yw4l">
                                <table id="example" style="width: 100%;" border="1" >
                                        ...
                                        <th style="background-color: #2a3f54;color: white;font-weight: bolder;text-align: center;" colspan="6" >POZO A TIERRA</th>
                                        ...
                                        <tbody>
                                        <?php  
                                        $ni = $sel->consultaExportEquipo($rondax,"13"); 
                                        $ct = 1;
                                        while($mue = $ni->fetch_assoc()){ ?>
                                        <tr class="">
                                         <td style="text-align: center;"><?php echo $mue["id_cod"]; ?></td>
